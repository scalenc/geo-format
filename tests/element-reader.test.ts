...
import { ArcSegment } from '../src/model/arc-segment';
import { ArrowElement } from '../src/model/arrow-element';
import { CircleElement } from '../src/model/circle-element';
import { ConstructionCircleElement } from '../src/model/construction-circle-element';
import { ConstructionLineElement } from '../src/model/construction-line-element';
import { LineSegment } from '../src/model/line-segment';
import { PointElement } from '../src/model/point-element';
import { QuadElement } from '../src/model/quad-element';
import { TextElement } from '../src/model/text-element';
import { ElementReader } from '../src/persistency/element-reader';
import { Parser } from '../src/persistency/parser';

describe('test ElementReader', () => {
  [
    { text: 'UNKNOWN\n1 0\n2 1\n3\n1\n2\n3\n|~\n...', throws: /Unknown element type/ },
  ].forEach((test) => {
  ...
  [
    ...
    { text: 'ARC\n1 0\n13 14 15\n1\n|~\n...', expect: { type: 'ARC', color: 1, stroke: 0, centerPointIndex: 13, startPointIndex: 14, endPointIndex: 15, orientation: 1, isRounding: false, attributes: undefined } as ArcSegment },
    { text: 'FIL\n1 0\n13 14 15\n1\n|~\n...', expect: { type: 'FIL', color: 1, stroke: 0, centerPointIndex: 13, startPointIndex: 14, endPointIndex: 15, orientation: 1, isRounding: true, attributes: undefined } as ArcSegment },
    ...
    { text: 'QUAD\n1 0\n13 14 15 16\n1 2\n|~\n...', expect: { type: 'QUAD', color: 1, stroke: 0, cornerPoint1Index: 13, cornerPoint2Index: 14, cornerPoint3Index: 15, cornerPoint4Index: 16, fill: 1, fillColor: 2, attributes: undefined } as QuadElement },
    {
      text: 'TXT\n1 0\n13\n10.0 1.3 90.0\n1.5 45.0\n36 1 3\nText1\nHello\nWorld!\n|~\n...',
      expect: {
        type: 'TXT',
