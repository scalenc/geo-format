...
export class PartReader {
    ...
    public read(): Part {
        ...
        for (; ;) {
            ...
            else if (section == constants.PART_COPIES_SECTION) {
                this.readCopies(part);
            }
            else if (section == constants.PART_SUBPART_SECTION) {
                this.readSubparts(part);
            }
            else if (section == constants.PART_BENDING_SECTION) {
                this.readBendings(part);
            }
            else if (section == constants.PART_ATTRIBUTE_SECTION) {
                this.readPartAttributes(part);
            }
            else if (section == constants.PART_ELEMENT_ATTRIBUTE_SECTION) {
                this.readElementAttributes(part);
            }
            else if (section == constants.PART_BEND_ATTRIBUTE_SECTION) {
